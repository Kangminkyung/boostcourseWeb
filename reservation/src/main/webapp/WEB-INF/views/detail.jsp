...
<body>
	<div id="container">
		<div class="header fade">
			<header class="header_tit">
				...
				<a href="<%=request.getContextPath() %>/myReservation" class="btn_my"> <span title="예약확인">예약확인</span> </a>
			</header>
		</div>
		
		<div class="ct main" data-display-id = "${displayInfoId}">
			<div>
				<!-- 1. 상단영역 -->
				<div class="section_visual" data-display-id = "${productId}">
			 		<header>
                		<h1 class="logo">
                    		<a href="<%=request.getContextPath() %>"  class="lnk_logo" title="네이버"> <span class="spr_bi ico_n_logo">네이버</span> </a>
                    		<a href="<%=request.getContextPath() %>" class="lnk_logo" title="예약"> <span class="spr_bi ico_bk_logo">예약</span> </a>
                    	</h1>
                    	<a href="<%=request.getContextPath() %>/myReservation" class="btn_my"> <span class="viewReservation" title="예약확인">예약확인</span> </a>
                	</header>	
					...
					<div class="group_btn_goto" style="display: none;">
							...
							<a class="btn_goto_email" title="이메일" href="#"> <i class="fn fn-mail1"></i> </a>
				...
				<div class="section_event">
					<div class="event_info_box">
						...
						<div class="event_info">
							<div class="in_dsc">[네이버예약 특별할인]<br>R석 50%, S석 60% 할인<!-- productEvent --></div>
						</div>
					</div>
				</div>
				...
				<!--  <button type="button" class="bk_btn" onClick="location.href='<%=request.getContextPath()%>/reservations?id=${displayInfo.displayInfoId}'"> -->
					<button type="button" class="bk_btn" onClick="location.href='<%=request.getContextPath()%>/reserve?displayInfoId=${displayInfoId}&productId=${productId}'">
				...
				<div class="section_review_list">
					...
					<a href="<%=request.getContextPath() %>/review?displayInfoId=${displayInfoId}&productId=${productId}" class="btn_review_more"> <span>예매자 한줄평 더보기</span> <i class="fn fn-forward1"></i> </a>
				</div>
				...
				<div class="section_info_tab">
					...
					<ul class="info_tab_lst">
						<!-- active 추가 -->
						<!-- data- (data-정의할 문자)를 통해 사용자가  속성을 정하고 값을 전달할 수 있다-->
					...
					<div class="detail_area_wrap" data-info="detail">
					...
					<div class="detail_location hide" data-info="path">
								...
								<div class="lst_store_info_wrap">
									<ul class="lst_store_info">
										<li class="item">
											...
											<span class="item_rt">
												<a href="tel:02-548-0597" class="store_tel"></a>
											</span>
										</li>
									</ul>
								</div>
	...
	<script type="reservation_template" id="comment">
		<li class="list_item">
			<div>
	...
	<script type="reservation_template" id="productImageInfo">
		<li class="in_img_lst">
         	<img alt="" class="img_thumb second" src="{{productSaveFileName}}">
        </li>
	</script>
</body>
</html>