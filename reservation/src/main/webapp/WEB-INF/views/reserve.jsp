...
<body>
                ...
                <div class="section_booking_form">
                            ...
                            <div class="agreement_nessasary help_txt"> <span class="spr_book ico_nessasary"></span> <span>필수입력</span> </div>
                                ...
                                <div class="inline_form"> <label class="label" for="name"> <span class="spr_book ico_nessasary">필수</span> <span>예매자</span> </label>
                                    <div class="inline_control name_wrap"> 
                                    	...
                                    	<div class="warning_msg">문자만 입력 가능합니다</div>
                                    </div>
                                </div>
                                ...
                                <div class="inline_form"> <label class="label" for="email">  <span class="spr_book ico_nessasary">필수</span>  <span>이메일</span> </label>
                                    <div class="inline_control email_wrap"> 
                                    	...
                                    	<div class="warning_msg">이메일 형식에 맞게 입력하세요</div>
                                    </div>
                                </div>
                                <div class="inline_form last" data-reservation-date="${reservationDate}"> <label class="label" for="message">예매내용</label>
                    ...
                    <div class="section_booking_agreement">
                        ...
                        <div class="agreement"> <span class="chk_txt_span"> <i class="spr_book ico_arr_ipc2"></i> <span>개인정보 수집 및 이용 동의</span> </span>
                            ...
                            <div class="useragreement_details">&lt;개인정보 수집 및 이용 동의&gt;<br><br> 
                        ...
                        <div class="agreement"> <span class="chk_txt_span"> <i class="spr_book ico_arr_ipc2"></i> <span>개인정보 제3자 제공 동의</span> </span>
                            ...
                            <div class="useragreement_details custom_details_wrap">
                                <div class="custom_details">&lt;개인정보 제3자 제공 동의&gt;<br><br> 
                                	...
                                	5. 동의 거부권 등에 대한 고지 : 정보주체는 개인정보 제공 동의를 거부할 권리가 있으나, 이 경우 상품 및 서비스 예약이 제한될 수 있습니다.<br></div>
                            </div>
                        </div>
                    </div>
                </div>
	...
	<script type="reservation_template" id="productDescription">
		<h2>
			<span class="title">
				{{productDescription}}
			</span>
	...
	<script type="reservation_template" id="titleInfo">
    	<li class="item" style="width: 414px;"> 
			<img alt="" class="img_thumb" src="{{productSaveFileName}}"> 
			<span class="img_bg"></span>
    		<div class="preview_txt">
        		<h2 class="preview_txt_tit">{{productDescription}}</h2> 
				<em class="preview_txt_dsc">₩{{minimumPrice}} ~ </em>
				<em class="preview_txt_dsc">잔여티켓 : 제한없음</em> 
			</div>
		</li>
	</script>
	
	<script type="reservation_template" id="storeDetails">
    <div class="store_details">
    	<h3 class="in_tit">{{displayInfo.productDescription}}</h3>
    	<p class="dsc">
			장소 : {{displayInfo.placeName}} <br/>
			{{displayInfo.placeStreet}} <br/>
			(구.{{displayInfo.placeLot}})<br>
		</p>
	...
	<script type="reservation_template" id="productPrices">
	<div class="qty" data-price-id="{{productPriceId}}" data-price-type="{{priceTypeName}}">
		<div class="count_control">
			<!-- [D] 수량이 최소 값이 일때 ico_minus3, count_control_input에 disabled 각각 추가, 수량이 최대 값일 때는 ico_plus3에 disabled 추가 -->
			<div class="clearfix _ticket_count_control">
			...
			<div class="individual_price" data-dc-price="{{discountPrice}}">
	...
	<script type="reservation_template" id="hiddenInfo">
