...
<html lang="ko" class="no-js" >
   ...
   <body class="biz  ko" >
         ...
         <div class="_view_content" ui-view="content" id="container" >
            <booked-confirm>
               <div class="booking_login">
                  <h1 class="login_header"> <a href="<%=request.getContextPath() %>"  class="nbooking_logo spr_bi txt_logo" > <span translate="CM-NBOOKING">네이버 예약</span> </a> </h1>
                  <!----> 
                     <form name="confirm_form" class="ng-pristine ng-valid" id="form1" action="<%=request.getContextPath() %>/myreservation">
                        ...
                        <div class="login_form"> 
                           ...
                           <input type="text" class="login_input ng-pristine ng-untouched ng-valid ng-empty" id="resrv_id" name="reservationEmail" aria-invalid="false" placeholder="crong@naver.com" title="예매자이메일" required>
								<div class="warning_msg" data-valid="false" style="display: none;">올바른 이메일 형식이 아닙니다</div>
                         </div>
	...
	<script type="reservation_template" id="warning_msg">
   		<div class="warning_msg" data-valid="false">올바른 이메일 형식이 아닙니다</div>
   </script>
